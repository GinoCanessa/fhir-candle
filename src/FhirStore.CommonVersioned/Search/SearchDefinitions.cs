...
public static class SearchDefinitions
{
    ...
    public static readonly HashSet<string> SupportedSearchCombinations = new()
    {
        ...
        "reference-resourcetype-canonical",
        "reference-resourcetype-uri",
        "reference-resourcetype-url",
        "reference-resourcetype-reference",
        "reference-resourcetype-oid",
        "reference-resourcetype-uuid",
        "string-address",
        "string-humanname",
        "string-id",
        "string-string",
    ...
    public static readonly HashSet<string> UnsupportedSearchCombinations = new()
    {
        ...
        "reference-identifier-canonical",   // note that mapping identifier to canonical is specifically disallowed
